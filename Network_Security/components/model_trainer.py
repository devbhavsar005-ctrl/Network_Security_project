...
from Network_Security.entity.artifacts_entity import DataTransformationArtifacts,ModelTrainerArtifacts
...
from Network_Security.utils.ml_utils.metrics.classificatin_metrics import Get_classification_score
...
class ModelTrainer:
    ...
    def train_model(self,X_train,y_train,x_test,y_test):
        ...
        classification_train_metric=Get_classification_score(y_true=y_train,y_predict=y_train_pred)
        ...
        classification_test_metric=Get_classification_score(y_true=y_test,y_predict=y_test_pred)
